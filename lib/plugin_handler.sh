...
for plugin_name in ${ALRC_PLUGINS[@]}; do                                                     alias al_include_${plugin_name}="source $ALRC_HOME/plugins/${plugin_name}.alrc.plugin.sh" &> /dev/null;
done
unset plugin_name

# Deaktive plugin
alias al_exclude_brandomusic='source $ALRC_HOME/plugins/.al_disable_brandomusic_legacy.alrc.plugin.sh'
alias al_exclude_brandomusicx='source $ALRC_HOME/plugins/c
.al_disable_brandomusic_extended.alrc.plugin.sh'
